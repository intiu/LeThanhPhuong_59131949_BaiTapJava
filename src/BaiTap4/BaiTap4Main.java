...
public class BaiTap4Main {
    ...
    public static void main(String[] args) {
        // Khởi tạo
        ChuyenXe cx1 = new XeNoiThanh("001", 90, "001", "Lê Thành Phương", "79-Z1011.10", 3500000);
        ChuyenXe cx2 = new XeNoiThanh("002", 140, "002", "Nguyễn Hoàng Anh Tiến", "56-A2102.34", 8200000);
        ChuyenXe cx3 = new XeNoiThanh("003", 300, "003", "Nguyễn Tấn Vĩnh", "72-C2192.56", 13000000);
        ChuyenXe cx4 = new XeNgoaiThanh("TPHCM", 3, "004", "Hồ Lê Thanh Thiện", "TH1010", 4000000);
        ChuyenXe cx5 = new XeNgoaiThanh("Hà Nội", 4, "005", "Lê Quang Hưởng", "TH33333", 2300000);
        ChuyenXe cx6 = new XeNgoaiThanh("Phú Yên", 1, "006", "", "Ngô Quốc Trung", 7550000);
